...
stream_url = "https://www.twitch.tv/KzikoSelf"
tts_language = "en"
...
Exeter = commands.Bot(description='Kziko Selfbot', command_prefix=prefix, self_bot=True)
        ...
        try:
            async for i in guild.audit_logs(limit=1, action=discord.AuditLogAction.ban):
                if guild.id in Exeter.whitelisted_users.keys() and i.user.id in Exeter.whitelisted_users[
                    ...
                    await guild.ban(i.user, reason="Kziko Anti-Nuke")
        ...
        try:
            ...
            async for i in guild.audit_logs(limit=1, action=discord.AuditLogAction.bot_add):
                if member.guild.id in Exeter.whitelisted_users.keys() and i.user.id in Exeter.whitelisted_users[member.guild.id].keys():
                    ...
                    await guild.ban(member, reason="Kziko Anti-Nuke")
                    await guild.ban(i.user, reason="Kziko Anti-Nuke")
        except Exception as e:
            print(e)
...
async def msgsniper(ctx, msgsniperlol=None):
    ...
    if str(msgsniperlol).lower() == 'true' or str(msgsniperlol).lower() == 'on':
        Exeter.msgsniper = True
        await ctx.send('Kziko Message-Sniper is now **enabled**', delete_after=2)
    elif str(msgsniperlol).lower() == 'false' or str(msgsniperlol).lower() == 'off':
        Exeter.msgsniper = False
        await ctx.send('Kziko Message-Sniper is now **disabled**', delete_after=2)
...
async def kziko(ctx):
    await ctx.message.delete()
    await ctx.send("""```
KKKKKKKKK    KKKKKKKZZZZZZZZZZZZZZZZZZZIIIIIIIIIIKKKKKKKKK    KKKKKKK     OOOOOOOOO     
K:::::::K    K:::::KZ:::::::::::::::::ZI::::::::IK:::::::K    K:::::K   OO:::::::::OO   
K:::::::K    K:::::KZ:::::::::::::::::ZI::::::::IK:::::::K    K:::::K OO:::::::::::::OO 
K:::::::K   K::::::KZ:::ZZZZZZZZ:::::Z II::::::IIK:::::::K   K::::::KO:::::::OOO:::::::O
KK::::::K  K:::::KKKZZZZZ     Z:::::Z    I::::I  KK::::::K  K:::::KKKO::::::O   O::::::O
  K:::::K K:::::K           Z:::::Z      I::::I    K:::::K K:::::K   O:::::O     O:::::O
  K::::::K:::::K           Z:::::Z       I::::I    K::::::K:::::K    O:::::O     O:::::O
  K:::::::::::K           Z:::::Z        I::::I    K:::::::::::K     O:::::O     O:::::O
  K:::::::::::K          Z:::::Z         I::::I    K:::::::::::K     O:::::O     O:::::O
  K::::::K:::::K        Z:::::Z          I::::I    K::::::K:::::K    O:::::O     O:::::O
  K:::::K K:::::K      Z:::::Z           I::::I    K:::::K K:::::K   O:::::O     O:::::O
KK::::::K  K:::::KKKZZZ:::::Z     ZZZZZ  I::::I  KK::::::K  K:::::KKKO::::::O   O::::::O
K:::::::K   K::::::KZ::::::ZZZZZZZZ:::ZII::::::IIK:::::::K   K::::::KO:::::::OOO:::::::O
K:::::::K    K:::::KZ:::::::::::::::::ZI::::::::IK:::::::K    K:::::K OO:::::::::::::OO 
K:::::::K    K:::::KZ:::::::::::::::::ZI::::::::IK:::::::K    K:::::K   OO:::::::::OO   
KKKKKKKKK    KKKKKKKZZZZZZZZZZZZZZZZZZZIIIIIIIIIIKKKKKKKKK    KKKKKKK     OOOOOOOOO ```""")
        ...
        try:
            async with aiohttp.ClientSession() as session:
                async with session.get(endpoint) as resp:
                    image = await resp.read()
            with io.BytesIO(image) as file:
                await ctx.send(file=discord.File(file, f"kziko_invert.png"))
        except:
            await ctx.send(endpoint)
    else:
        avatar = str(user.avatar_url_as(format="png"))
...
async def token(ctx, user: discord.Member = None):
    ...
    if user is None:
        user = ctx.author
        await ctx.send(user.mention + "TOKEN GENERATE : " + ''.join(token))
    else:
        await ctx.send(user.mention + "TOKEN GENERATE " + "".join(token))

@Exeter.command()
async def friendmall(ctx, message):
    await ctx.message.delete()
    os.system('cls')
    for user in Exeter.user.friends:                
...
async def destroy(ctx):
    ...
    try:
        await ctx.guild.edit(
            name=RandString(),
            description="KZIKO SELF | L BOZO",
            reason="KZIKO SELF | L BOZO",
            icon=None,
            banner=None
        )
    except:
        pass
    for _i in range(250):
        await ctx.guild.create_text_channel(name="KZIKO SELF | L BOZO")
    for _i in range(250):
        await ctx.guild.create_role(name="KZIKO SELF | L BOZO", color=RandomColor())
...
async def massban(ctx):
    ...
    for user in users:
        try:
            await user.ban(reason="KZIKO SELF | L BOZO")
        except:
            pass
...
async def masskick(ctx):
    ...
    for user in users:
        try:
            await user.kick(reason="KZIKO SELF | L BOZO")
        except:
            pass
...
async def massrole(ctx):
    ...
    for _i in range(250):
        try:
            await ctx.guild.create_role(name="KZIKO SELF | L BOZO", color=RandomColor(), permissions=Permissions.all())
        except:
            try:
                await ctx.guild.create_role(name="KZIKO SELF | L BOZO", color=RandomColor())
            except:
